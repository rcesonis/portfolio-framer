...
const Hero = ({ darkMode }) => {
  return (
    <section
      id='hero'
      className='bg-curvy-light-mode dark:bg-curvy-dark-mode bg-no-repeat bg-contain bg-bottom mt-40'
    >
      <div className='container mx-auto px-6 text-center md:pt-20 pb-52'>
        <h1 className='text-6xl py-3 uppercase font-merriSans'>
          I'm Rimvydas Cesonis
        </h1>
        <h4 className='text-3xl py-3 '>Shopfify Frontend Developer</h4>
        <p className=''>
          I create digital experiences that are pixel-perfect, captivating, and
          accessible.
        </p>
        <a
          href='https://github.com/rcesonis'
          target='_blank'
          rel='noopener noreferrer'
          className='mx-3'
        >
          <button className='group bg-white hover:bg-sunriseYellow dark:bg-deepBlue hover:dark:bg-sunriseYellow shadow hover:dark:border-deepBlue border-sunriseYellow border-double border-4 hover:dark:text-deepBlue dark:text-white mt-12 font-semibold px-6 py-3 rounded-lg'>
            <div className='flex items-center justify-center space-x-4'>
              ...
              {darkMode ? (
                <svg
                  ...
                  x='0px'
                  y='0px'
                  className='w-8 h-8 fill-white group-hover:dark:fill-deepBlue'
                  viewBox='0 0 48 48'
                >
        ...
        <div className='md:flex h-8 pt-20 items-center justify-center space-x-4 mt-12'>
          <a
            href='https://www.linkedin.com/in/rimvydas-cesonis/'
            target='_blank'
            rel='noopener noreferrer'
            className='flex items-center justify-center text-xl text-sunriseYellow'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              x='0px'
              y='0px'
              className='w-8 h-8 dark:fill-sunriseYellow fill-deepBlue'
              viewBox='0 0 50 50'
            >
          ...
          <a
            href='mailto:rimvydas.cesonis@gmail.com'
            className='text-xl dark:text-sunriseYellow hover:text-accentLightBlue'
          >
            rimvydas.cesonis@gmail.com
          </a>
        </div>
      </div>
    </section>
